...
fn DefaultPage() -> impl IntoView {
    view! {
        ...
        <div id="container">
            ...
            //
            // next step is to:
            // figure out how to put pages in a folder and stuff.
            //
            // other thing i wanna figure out how to do later is:
            // how to create new pages as a user. using notion as an example. creating a new subpage and then being able to go to it.
